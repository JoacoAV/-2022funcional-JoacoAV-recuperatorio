...
--Si un hechizo no deja el peso en 0, la temperatura en 0 o no deja al postre sin sabores, la ejecución nunca cortaría porque todos los postres que lee están listos y nunca va a encontrar uno no listo. 